...
echo "║     Login            →  admin / admin@scada2024                   ║"
echo "║                                                                   ║"
echo "╠══════════════════════════════════════════════════════════════════╣"
echo "║                                                                   ║"
...
echo "║     GEN-001  →  operator_gen001 / gen001@scada                     ║"
echo "║     GEN-002  →  operator_gen002 / gen002@scada                     ║"
echo "║     SUB-001  →  operator_sub001 / sub001@scada                     ║"
echo "║     SUB-002  →  operator_sub002 / sub002@scada                     ║"
echo "║     SUB-003  →  operator_sub003 / sub003@scada                     ║"
echo "║     DIST-001 →  operator_dist001 / dist001@scada                    ║"
echo "║     DIST-002 →  operator_dist002 / dist002@scada                    ║"
echo "║                                                                   ║"
echo "╚══════════════════════════════════════════════════════════════════╝"
echo ""
