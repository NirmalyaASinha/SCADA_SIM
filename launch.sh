...
echo "║     GEN-001  →  operator_gen1 / gen1@scada                        ║"
echo "║     GEN-002  →  operator_gen2 / gen2@scada                        ║"
echo "║     SUB-001  →  operator_sub1 / sub1@scada                        ║"
echo "║     SUB-002  →  operator_sub2 / sub2@scada                        ║"
echo "║     SUB-003  →  operator_sub3 / sub3@scada                        ║"
echo "║     DIST-001 →  operator_dist1 / dist1@scada                      ║"
echo "║     DIST-002 →  operator_dist2 / dist2@scada                      ║"
echo "║                                                                   ║"
echo "╚══════════════════════════════════════════════════════════════════╝"
echo ""
